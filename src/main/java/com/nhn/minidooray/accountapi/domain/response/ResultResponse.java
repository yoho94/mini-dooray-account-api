...
public class ResultResponse<T> {
    ...
    public static <T> ResultResponse<T> created(List<T> result) {
        return buildResultResponse( true, HttpStatus.CREATED.value(), "created successfully",
            result );
    }
    ...
    public static <T> ResultResponse<T> deleted(List<T> result) {
        return buildResultResponse( true, HttpStatus.NO_CONTENT.value(), "deleted successfully",
            result );
    }
    ...
    private static <T> ResultResponse<T> buildResultResponse(boolean isSuccessful, int resultCode,
        String resultMessage, List<T> result) {
