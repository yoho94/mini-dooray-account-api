...
public class AccountStateController {
    ...
    public ResultResponse<AccountStateDto> createAccountState(@RequestBody @Valid AccountStateCreateRequest accountStateCreateRequest, BindingResult bindingResult) {
        ...
        return ResultResponse.<AccountStateDto>builder()
            .header(ResultResponse.Header.builder()
                .isSuccessful(true)
                .resultCode(HttpStatus.CREATED.value())
                .resultMessage("Account state created successfully")
                .build())
            .result(Collections.singletonList(createdAccountState))
            .build();
    }

    @PutMapping("${com.nhn.minidooray.accountapi.requestmapping.update-state}")
    public ResultResponse<AccountStateDto> updateAccountState(@RequestBody @Valid AccountStateCreateRequest accountStateCreateRequest, BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            throw new ValidationFailedException(bindingResult);
        }
        ...
        return ResultResponse.<AccountStateDto>builder()
            .header(ResultResponse.Header.builder()
                ...
                .resultMessage("Account state updated successfully")
                .build())
            .result(Collections.singletonList(updatedAccountState))
            .build();
    }

    @GetMapping("${com.nhn.minidooray.accountapi.requestmapping.read-state-by-code}")
    public ResultResponse<AccountStateDto> readAccountStateByCode(@PathVariable("code") String code) {
        ...
        return ResultResponse.<AccountStateDto>builder()
            .header(ResultResponse.Header.builder()
                .isSuccessful(true)
                .resultCode(HttpStatus.OK.value())
                .resultMessage("Account state found")
                .build())
            .result(Collections.singletonList(accountStateDto))
            .build();
    }
    ...
    public ResultResponse<List<AccountStateDto>> readAccountStateList() {
        ...
        return ResultResponse.<List<AccountStateDto>>builder()
            .header(ResultResponse.Header.builder()
                .isSuccessful(true)
                .resultCode(HttpStatus.OK.value())
                .resultMessage("Account state list found")
                .build())
            .result(Collections.singletonList(accountStateDtoList))
            .build();
    }
    ...
    public ResultResponse<Void> deleteAccountStateByCode(@PathVariable("code") String code) {
        ...
        return ResultResponse.<Void>builder()
            .header(ResultResponse.Header.builder()
                ...
                .resultMessage("Account state deleted successfully")
                .build())
            .build();
    }
    ...
    public ResultResponse<Void> deleteAllAccountStates() {
        ...
        return ResultResponse.<Void>builder()
            .header(ResultResponse.Header.builder()
                .isSuccessful(true)
                .resultCode(HttpStatus.NO_CONTENT.value())
                .resultMessage("All account states deleted successfully")
                .build())
            .build();
    }
}
