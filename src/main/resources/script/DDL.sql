...
(
    ...
    INDEX `fk_ACCOUNT_ACCOUNT_STATE_ACCOUNT_STATE1_idx`
(
    `ACCOUNT_STATE_CODE` ASC
) VISIBLE,
...
(
    ...
    REFERENCES `nhn_academy_15`.`ACCOUNT`
(
    `ID`
)
    ON DELETE NO ACTION
...
(
    ...
    REFERENCES `nhn_academy_15`.`ACCOUNT_STATE`
(
    `CODE`
)
    ON DELETE NO ACTION
